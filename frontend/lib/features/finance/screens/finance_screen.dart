...
import 'package:swiftai_erp/features/finance/screens/open_item_clearing_screen.dart';
...
import 'package:swiftai_erp/features/finance/screens/ar/credit_memo_screen.dart';
import 'package:swiftai_erp/features/finance/screens/ar/down_payment_screen.dart';
import 'package:swiftai_erp/features/finance/screens/ar/incoming_payments_screen.dart';
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Accounts, journal entries, financial reports & reconciliations',
                    style: TextStyle(
                      fontSize: 13,
            ...
            Wrap(
              ...
              children: [
                ...
                _FinanceCard(
                  ...
                  title: 'Open Item Clearing',
                  subtitle: 'Clear and reconcile open items',
                  color: Colors.deepOrange,
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) =>
                          OpenItemClearingScreen(glService: glService),
                    ),
                  ),
                ),
              ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Down payments, supplier invoices, payments & auto-clearing',
                    style: TextStyle(
                      fontSize: 12,
                      color: Colors.white.withValues(alpha: 0.8),
                    ),
            ...
            Wrap(
              ...
              children: [
                ...
                _FinanceCard(
                  ...
                  subtitle:
                      'Pay vendor with auto-clearing & prepayment deduction',
                  color: Colors.green,
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'Credit limits, incoming payments, down payments & auto GL posting',
                    style: TextStyle(
                      fontSize: 12,
                      color: Colors.white.withValues(alpha: 0.8),
                    ),
              ...
              children: [
                _FinanceCard(
                  ...
                  onTap: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) =>
                          CreditLimitScreen(authService: authService),
                    ),
                  ),
                ),
                _FinanceCard(
                  ...
                  subtitle: 'Customer receipt and invoice clearing',
                  color: Colors.indigo,
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) =>
                          IncomingPaymentsScreen(glService: glService),
                    ),
                  ),
                ),
                _FinanceCard(
                  ...
                  title: 'Credit Memo',
                  subtitle: 'Create credits and match open invoices',
                  color: Colors.redAccent,
                  onTap: () => Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (_) => CreditMemoScreen(glService: glService),
                    ),
                  ),
                ),
                _FinanceCard(
                  ...
                  onTap: () => Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) =>
                          DownPaymentListScreen(authService: authService),
                    ),
                  ),
                ),
              ],
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const SizedBox(height: 4),
                  Text(
                    'Cost centers, allocations & controlling',
                    style: TextStyle(
                      fontSize: 12,
                      color: Colors.white.withValues(alpha: 0.8),
                    ),
