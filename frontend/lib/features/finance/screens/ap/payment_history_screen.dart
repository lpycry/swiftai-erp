...
class _PaymentHistoryScreenState extends State<PaymentHistoryScreen> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      final uri = Uri.parse(
        'http://localhost:8080/api/v1/purchase/payment-history',
      );
      ...
      if (resp.statusCode < 400) {
        ...
        _payments = data
            .map((d) => _PaymentRow.fromJson(d as Map<String, dynamic>))
            .toList();
      }
    } catch (_) {}
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                Text(
                  'Total: \$${ApService.fmtAmount(total)}',
                  style: TextStyle(
                    fontSize: 12,
            ...
            child: _loading
                ...
                : RefreshIndicator(
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (_, i) => _buildRow(_payments[i]),
                    ),
                  ),
          ),
        ],
      ...
      child: Row(
        children: [
          ...
          Expanded(
            flex: 2,
            child: Text(
              p.vendorName.isNotEmpty ? p.vendorName : p.vendorCode,
          ...
          Expanded(
            flex: 2,
            child: Text(
              '\$${ApService.fmtAmount(p.paymentAmount)}',
              textAlign: TextAlign.right,
              style: TextStyle(
                fontSize: 11,
                fontWeight: FontWeight.w600,
