...
class _TaxJurisdictionsTab extends StatefulWidget {
  ...
  @override
  State<_TaxJurisdictionsTab> createState() => _TaxJurisdictionsTabState();
}
    ...
    try {
      ...
      if (resp.statusCode < 400) {
        ...
        if (_stateFilter != null && _stateFilter!.isNotEmpty) {
          list = list
              .where(
                (e) => (e['state']?.toString() ?? '').toUpperCase().contains(
                  _stateFilter!.toUpperCase(),
                ),
              )
              .toList();
        }
  ...
  Future<void> _upsert(Map<String, dynamic>? existing) async {
    ...
    try {
      if (existing == null) {
        ...
        await http.put(
          Uri.parse(
            'http://localhost:8080/api/v1/finance-settings/tax-jurisdictions/${existing['id']}',
          ),
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer $_token',
  ...
  Future<void> _delete(String id, String label) async {
    final ok = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        title: const Text('Delete Tax Jurisdiction'),
    ...
    try {
      await http.delete(
        Uri.parse(
          'http://localhost:8080/api/v1/finance-settings/tax-jurisdictions/$id',
        ),
        headers: {'Authorization': 'Bearer $_token'},
      );
      _load();
      ...
      children: [
            ...
            children: [
              SizedBox(
                ...
                child: TextField(
                  ...
                  onChanged: (v) => _stateFilter = v.isEmpty ? null : v,
                  onSubmitted: (_) => _load(),
                ),
              ),
        ...
        Expanded(
          child: _loading
              ...
              : _items.isEmpty
              ? const Center(child: Text('No tax jurisdictions configured'))
              : ListView.builder(
                  itemCount: _items.length,
                  itemBuilder: (_, i) =>
                      _buildRow(_items[i] as Map<String, dynamic>),
                ),
        ),
      ],
    );
...
class _JurisdictionDialog extends StatefulWidget {
  ...
  @override
  State<_JurisdictionDialog> createState() => _JurisdictionDialogState();
}
...
class _JurisdictionDialogState extends State<_JurisdictionDialog> {
  ...
  void initState() {
    ...
    if (widget.existing != null) {
      ...
      if (e['effective_date'] != null) {
        _effDate = DateTime.parse(e['effective_date'].toString());
      }
      if (e['expiration_date'] != null) {
        _expDate = DateTime.parse(e['expiration_date'].toString());
      }
                    ...
                    child: InkWell(
                      onTap: () async {
                        final d = await showDatePicker(
                          context: context,
                          initialDate: _effDate,
                          firstDate: DateTime(2020),
                          lastDate: DateTime(2030),
                        );
                        if (d != null) setState(() => _effDate = d);
                      },
                      child: InputDecorator(
                        ...
                        child: Text(
                          '${_effDate.year}-${_effDate.month.toString().padLeft(2, '0')}-${_effDate.day.toString().padLeft(2, '0')}',
                          style: const TextStyle(
                            fontSize: 11,
          ...
          onPressed: () {
            ...
            Navigator.pop(context, {
              ...
              'expiration_date': _expDate == null
                  ? ''
                  : '${_expDate!.year}-${_expDate!.month.toString().padLeft(2, '0')}-${_expDate!.day.toString().padLeft(2, '0')}',
              'is_active': _isActive,
            });
          },
...
class _TaxNexusTab extends StatefulWidget {
  ...
  @override
  State<_TaxNexusTab> createState() => _TaxNexusTabState();
}
...
class _TaxNexusTabState extends State<_TaxNexusTab> {
  ...
  Future<void> _load() async {
    ...
    try {
      ...
      if (_activeOnly) params['active_only'] = 'true';
      final uri = Uri.parse(
        'http://localhost:8080/api/v1/finance-settings/tax-nexus',
      ).replace(queryParameters: params);
      final resp = await http.get(
        uri,
        headers: {'Authorization': 'Bearer $_token'},
  ...
  Future<void> _upsert(Map<String, dynamic>? existing) async {
    ...
    try {
      if (existing == null) {
        await http.post(
          Uri.parse('http://localhost:8080/api/v1/finance-settings/tax-nexus'),
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer $_token',
          },
        ...
        await http.put(
          Uri.parse(
            'http://localhost:8080/api/v1/finance-settings/tax-nexus/${existing['id']}',
          ),
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer $_token',
  ...
  Future<void> _delete(String id, String label) async {
    ...
    try {
      await http.delete(
        Uri.parse(
          'http://localhost:8080/api/v1/finance-settings/tax-nexus/$id',
        ),
        headers: {'Authorization': 'Bearer $_token'},
      );
      _load();
  ...
  String _nexusTypeLabel(String type) =>
      type == 'PHYSICAL' ? 'Physical' : 'Economic';
      ...
      children: [
        ...
        Expanded(
          child: _loading
              ? const Center(child: CircularProgressIndicator())
              : _items.isEmpty
              ? const Center(child: Text('No tax nexus configured'))
              : ListView.builder(
                  itemCount: _items.length,
                  itemBuilder: (_, i) =>
                      _buildRow(_items[i] as Map<String, dynamic>),
...
class _NexusDialog extends StatefulWidget {
  ...
  @override
  State<_NexusDialog> createState() => _NexusDialogState();
}
...
class _NexusDialogState extends State<_NexusDialog> {
  ...
  void initState() {
    ...
    if (widget.existing != null) {
      ...
      if (amt != null)
        _thresholdCtrl.text = (amt as num).toDouble().toStringAsFixed(0);
      if (e['effective_date'] != null) {
        _effDate = DateTime.parse(e['effective_date'].toString());
      }
      _isActive = e['is_active'] == true;
          ...
          child: Column(
            ...
            children: [
              ...
              Autocomplete<String>(
                ...
                optionsBuilder: (v) => _states.where(
              ...
              DropdownButtonFormField<String>(
                ...
                onChanged: (v) {
                  setState(() => _nexusType = v ?? 'PHYSICAL');
                },
                style: const TextStyle(fontSize: 13),
              ),
              const SizedBox(height: 8),
              ...
              if (_nexusType == 'ECONOMIC') ...[
                TextField(
                  ...
                  decoration: const InputDecoration(
                    labelText: 'Annual Sales Threshold (\$)',
                    isDense: true,
                    hintText: '500000',
                  ),
                  keyboardType: TextInputType.number,
...
class _TaxJurisdictionRulesTab extends StatefulWidget {
  final AuthService authService;
  final FinanceSettingsService svc;
  const _TaxJurisdictionRulesTab({
    required this.authService,
    required this.svc,
  });
  @override
  State<_TaxJurisdictionRulesTab> createState() =>
      _TaxJurisdictionRulesTabState();
}
...
class _TaxJurisdictionRulesTabState extends State<_TaxJurisdictionRulesTab> {
  ...
  Future<void> _load() async {
    ...
    try {
      final resp = await http.get(
        Uri.parse(
          'http://localhost:8080/api/v1/finance-settings/tax-jurisdiction-rules',
        ),
        headers: {'Authorization': 'Bearer $_token'},
      );
      if (resp.statusCode < 400) {
        ...
        if (_jurisFilter != null && _jurisFilter!.isNotEmpty) {
          list = list
              .where(
                (e) => (e['jurisdiction_code']?.toString() ?? '')
                    .toUpperCase()
                    .contains(_jurisFilter!.toUpperCase()),
              )
              .toList();
        }
        if (_catFilter != null && _catFilter!.isNotEmpty) {
          list = list
              .where(
                (e) => (e['tax_category_code']?.toString() ?? '')
                    .toUpperCase()
                    .contains(_catFilter!.toUpperCase()),
              )
              .toList();
        }
        _items = list;
        ...
        if (mounted)
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(
              content: Text('List failed: HTTP ${resp.statusCode}'),
  ...
  Future<void> _upsert(Map<String, dynamic>? existing) async {
    ...
    try {
      ...
      if (existing == null) {
        ...
        resp = await http.put(
          Uri.parse(
            'http://localhost:8080/api/v1/finance-settings/tax-jurisdiction-rules/$ruleId',
          ),
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer $_token',
      ...
      children: [
            ...
            children: [
              SizedBox(
                ...
                child: TextField(
                  ...
                  style: const TextStyle(fontSize: 12),
                  onChanged: (v) => _jurisFilter = v.isEmpty ? null : v,
                  onSubmitted: (_) => _load(),
                ),
              ),
              const SizedBox(width: 8),
              SizedBox(
                ...
                child: TextField(
                  ...
                  style: const TextStyle(fontSize: 12),
                  onChanged: (v) => _catFilter = v.isEmpty ? null : v,
                  onSubmitted: (_) => _load(),
                ),
              ),
              const Spacer(),
        ...
        Expanded(
          child: _loading
              ...
              : _items.isEmpty
              ? const Center(
                  child: Text('No product tax code rules configured'),
                )
              : ListView.builder(
                  itemCount: _items.length,
                  itemBuilder: (_, i) =>
      ...
      child: Row(
        children: [
          Expanded(
            flex: 1,
            child: Text(
              r['jurisdiction_code']?.toString() ?? '',
              style: TextStyle(
                fontSize: 11,
                fontWeight: FontWeight.w600,
                color: current ? null : Colors.grey,
              ),
            ),
          ),
          Expanded(
            ...
            child: Row(
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () => _delete(ruleId, label),
                  padding: EdgeInsets.zero,
                  constraints: const BoxConstraints(
                    minWidth: 28,
                    minHeight: 28,
...
class _TaxRuleDialog extends StatefulWidget {
  ...
  @override
  State<_TaxRuleDialog> createState() => _TaxRuleDialogState();
}
...
class _TaxRuleDialogState extends State<_TaxRuleDialog> {
  ...
  void initState() {
    ...
    if (widget.existing != null) {
      ...
      if (cv != null)
        _conditionCtrl.text = (cv as num).toDouble().toStringAsFixed(2);
      if (e['effective_from'] != null) {
        _effFrom = DateTime.parse(e['effective_from'].toString());
      }
      if (e['effective_to'] != null) {
        _effTo = DateTime.parse(e['effective_to'].toString());
      }
  ...
  Widget build(BuildContext context) {
    ...
    return AlertDialog(
      title: Text(
        isEdit ? 'Edit Tax Jurisdiction Rule' : 'Add Tax Jurisdiction Rule',
      ),
      content: SizedBox(
        width: 480,
        child: SingleChildScrollView(
            ...
            children: [
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  isDense: true,
                  hintText: 'e.g. CA_MILPITAS, TX_STATE',
                ),
              ...
              TextField(
                ...
                decoration: const InputDecoration(
                  ...
                  isDense: true,
                  hintText: 'e.g. 95035',
                  helperText: 'Optional — for granular jurisdiction matching',
                ),
                style: const TextStyle(fontSize: 13, fontFamily: 'monospace'),
              ),
              const SizedBox(height: 8),
                  ...
                  Expanded(
                    child: DropdownButtonFormField<String>(
                      ...
                      items: _conditionTypes
                          ...
                          .toList(),
                      onChanged: (v) =>
                          setState(() => _conditionType = v ?? 'NONE'),
                      style: const TextStyle(fontSize: 13),
                    ),
                  ),
                  const SizedBox(width: 8),
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          labelText: _conditionType == 'THRESHOLD'
                              ? 'Threshold (\$)'
                              : 'Flat Amount (\$)',
                          isDense: true,
                        ),
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: () async {
                        final d = await showDatePicker(
                          context: context,
                          initialDate: _effFrom,
                          firstDate: DateTime(2020),
                          lastDate: DateTime(2030),
                        );
                        if (d != null) setState(() => _effFrom = d);
                      },
                      child: InputDecorator(
                        decoration: const InputDecoration(
                        ...
                        child: Text(
                          '${_effFrom.year}-${_effFrom.month.toString().padLeft(2, '0')}-${_effFrom.day.toString().padLeft(2, '0')}',
                          style: const TextStyle(
                            fontSize: 11,
                            fontFamily: 'monospace',
                          ),
          ...
          onPressed: () {
            if (_jurisCtrl.text.isEmpty ||
              ...
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text(
                    'Jurisdiction Code, State Code, Tax Category, and Base Rate are required',
                  ),
                  backgroundColor: Colors.red,
                ),
              );
            ...
            if (rate == null) {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Invalid Base Rate'),
                  backgroundColor: Colors.red,
                ),
              );
              return;
            ...
            if (_effTo != null) {
              data['effective_to'] =
                  '${_effTo!.year}-${_effTo!.month.toString().padLeft(2, '0')}-${_effTo!.day.toString().padLeft(2, '0')}';
            }
            Navigator.pop(context, data);
          },
          child: Text(isEdit ? 'Update' : 'Create'),
...
class _TaxCategoriesTab extends StatefulWidget {
  ...
  @override
  State<_TaxCategoriesTab> createState() => _TaxCategoriesTabState();
}
    ...
    try {
      ...
      if (resp.statusCode < 400) {
        ...
        if (_codeFilter != null && _codeFilter!.isNotEmpty) {
          list = list
              .where(
                (e) => (e['code']?.toString() ?? '').toUpperCase().contains(
                  _codeFilter!.toUpperCase(),
                ),
              )
              .toList();
        }
  ...
  Future<void> _upsert(Map<String, dynamic>? existing) async {
    ...
    try {
      ...
      if (existing == null) {
        ...
        resp = await http.put(
          Uri.parse(
            'http://localhost:8080/api/v1/finance-settings/tax-categories/$id',
          ),
          headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Bearer $_token',
      ...
      children: [
            ...
            children: [
              SizedBox(
                ...
                child: TextField(
                  ...
                  style: const TextStyle(fontSize: 12),
                  onChanged: (v) => _codeFilter = v.isEmpty ? null : v,
                  onSubmitted: (_) => _load(),
                ),
              ),
              const Spacer(),
        ...
        Expanded(
          child: _loading
              ? const Center(child: CircularProgressIndicator())
              : _items.isEmpty
              ? const Center(child: Text('No tax categories configured'))
              : ListView.builder(
                  itemCount: _items.length,
                  itemBuilder: (_, i) =>
                      _buildRow(_items[i] as Map<String, dynamic>),
...
class _TaxCategoryDialog extends StatefulWidget {
  ...
  @override
  State<_TaxCategoryDialog> createState() => _TaxCategoryDialogState();
}
        ...
        FilledButton(
          onPressed: () {
            ...
            if (code.length > 4) {
              ScaffoldMessenger.of(context).showSnackBar(
                const SnackBar(
                  content: Text('Code must be 4 characters or fewer'),
                  backgroundColor: Colors.red,
                ),
              );
              return;
