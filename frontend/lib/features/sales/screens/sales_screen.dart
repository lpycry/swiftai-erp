...
class SalesScreen extends StatelessWidget {
  ...
  const SalesScreen({super.key, required this.authService, required this.salesService});

  @override
  Widget build(BuildContext context) {
    return AppLayout(
      authService: authService, currentIndex: 3, onIndexChanged: (_) {},
      title: 'Sales',
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  Row(children: [
                    Icon(Icons.store_rounded, size: 32, color: Colors.white.withValues(alpha: 0.9)),
                    const SizedBox(width: 12),
                    Text('Sales', style: TextStyle(fontSize: 20, fontWeight: FontWeight.w600, color: Colors.white)),
                  ]),
                  const SizedBox(height: 8),
                  Text('Sales prices & pricing configuration',
            ...
            Wrap(spacing: 16, runSpacing: 16, children: [
              ...
              _SalesCard(
                ...
                color: Colors.grey,
                onTap: () => ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Sales invoices coming soon'), behavior: SnackBarBehavior.floating)),
              ),
            ]),
