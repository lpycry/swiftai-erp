      ...
      return Center(
        child: Column(
          ...
          children: [
            ...
            Text(
              'Receipts are created when goods are received against POs via the GR screen in Logistics',
                  ...
                  Row(
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              r.itemName.isNotEmpty ? r.itemName : r.itemSku,
                              style: TextStyle(
                                fontSize: 12,
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                            '${r.quantity} @ ${PurchaseService.fmtAmount(r.unitCost)}',
                            style: const TextStyle(fontSize: 12),
                          ),
                          Text(
                            'Total: ${PurchaseService.fmtAmount(r.totalCost)}',
                            style: TextStyle(
                              fontSize: 12,
                              fontWeight: FontWeight.w600,
                  ...
                  Row(
                    children: [
                      if (r.batchNo.isNotEmpty)
                        _chip('Batch: ${r.batchNo}', Colors.blue),
                      if (r.batchNo.isNotEmpty) const SizedBox(width: 6),
                      _chip(
                        r.siteName.isNotEmpty ? r.siteName : r.siteCode,
                        Colors.grey,
                      ),
                      const Spacer(),
                      Text(
