          ...
          child: ListView.builder(
            ...
            itemBuilder: (_, i) {
              ...
              return ListTile(
                ...
                subtitle: Text(
                  '${inv.vendorName} - \$${inv.totalAmount.toStringAsFixed(2)}',
                ),
            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    ...
                    if (inv.matchStatus.isNotEmpty) ...[
                      ...
                      Container(
                        ...
                        child: Text(
                          inv.matchStatus.replaceAll('_', ' '),
                          style: TextStyle(
                            fontSize: 10,
                            fontWeight: FontWeight.w600,
                            color: _matchColor(inv.matchStatus),
                          ),
                        ),
                      ),
                    ],
                ...
                if (inv.poNumber.isNotEmpty)
                  _infoRow('PO Reference', inv.poNumber),
                _infoRow('Currency', inv.currency),
                _infoRow(
                  'Total Amount',
                  '\$${PurchaseService.fmtAmount(inv.totalAmount)}',
                ),
                _infoRow(
                  'Tax Amount',
                  '\$${PurchaseService.fmtAmount(inv.taxAmount)}',
                ),
                _infoRow(
                  'Net Amount',
                  '\$${PurchaseService.fmtAmount(inv.totalAmount - inv.taxAmount)}',
                ),
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Text(
                          '${PurchaseService.fmtAmount(item.unitPrice)}/${item.quantity > 0 ? 'ea' : ''}',
                          style: TextStyle(
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          'GR Qty: ${_fmtQty(item.grQuantity)}',
                          style: TextStyle(
                            fontSize: 12,
                        ...
                        const Spacer(),
                        Text(
                          'Total: \$${PurchaseService.fmtAmount(item.lineTotal)}',
                          style: const TextStyle(
                            fontWeight: FontWeight.w500,
                            fontSize: 12,
                          ),
                    ...
                    if (item.poUnitPrice > 0) ...[
                      ...
                      Row(
                        children: [
                          Text(
                            'PO Price: \$${PurchaseService.fmtAmount(item.poUnitPrice)}',
                            style: TextStyle(
                              fontSize: 11,
                          ...
                          if (item.priceDiff != 0)
                            Text(
                              'Price Diff: \$${PurchaseService.fmtAmount(item.priceDiff)}',
                              style: TextStyle(
                                fontSize: 11,
                                color: item.priceDiff > 0
                                    ? Colors.red.shade600
      ...
      child: Column(
        children: [
          ...
          if (widget.invoiceId != null && _error != null) ...[
            ...
            Text(
              'Or enter invoice number, PO number, or vendor name above',
